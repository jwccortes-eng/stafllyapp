...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!stripeKey) {
      console.error("[billing-checkout] STRIPE_SECRET_KEY not configured");
      return new Response(
    ...
    console.log(`[billing-checkout] Session created for user=${user.id}, company=${companyId}, session=${session.id}`);
