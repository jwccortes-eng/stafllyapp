...
BEGIN
  ...
  IF _daily_concept_id IS NOT NULL THEN
    ...
    INSERT INTO movements (company_id, period_id, employee_id, concept_id, quantity, rate, total_value, note)
    SELECT _company_id, _period_id, ds.employee_id, _daily_concept_id, ds.days_worked, ds.daily_rate, ds.days_worked * ds.daily_rate, 'Auto: Daily Pay'
