DROP FUNCTION IF EXISTS public.versioned_assignment_transition(uuid,uuid,text,text,integer,text,uuid,text,text);
...
REVOKE ALL ON FUNCTION public.versioned_assignment_transition(uuid,uuid,text,text,integer,text,uuid,text,text,text) FROM public;
GRANT EXECUTE ON FUNCTION public.versioned_assignment_transition(uuid,uuid,text,text,integer,text,uuid,text,text,text) TO authenticated;
GRANT EXECUTE ON FUNCTION public.versioned_assignment_transition(uuid,uuid,text,text,integer,text,uuid,text,text,text) TO service_role;