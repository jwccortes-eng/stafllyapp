...
export default function Invoices() {
  ...
  const loadData = async () => {
    ...
    const [invRes, cliRes] = await Promise.all([
      supabase.from("legacy_invoices").select("*").eq("company_id", selectedCompanyId).order("created_at", { ascending: false }),
  ...
  const handleCreate = async () => {
    ...
    setSaving(true);
    const { error } = await supabase.from("legacy_invoices").insert({
