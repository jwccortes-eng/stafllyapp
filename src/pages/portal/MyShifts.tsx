...
export default function MyShifts() {
  ...
  return (
    <div className="space-y-4 animate-fade-in">
      {/* Header */}
      <div className="pt-1">
        <h1 className="text-xl font-bold font-heading tracking-tight text-foreground flex items-center gap-2">
      ...
      {/* Tab bar */}
      <div className="flex items-center gap-1 bg-muted/40 p-1 rounded-xl overflow-x-auto no-scrollbar">
        {tabs.map((t) => (
          <button
            key={t.key}
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          className="p-1.5 rounded-lg text-muted-foreground/50 hover:text-foreground hover:bg-muted/50 transition-colors shrink-0"
        >
