...
const TYPE_ROUTES: Record<string, string> = {
  ...
  shift_updated_reaccept: "/portal/shifts",
...
const TYPE_COLORS: Record<string, string> = {
  ...
  shift_reminder_24h: "bg-indigo-500",
  shift_reminder_1h: "bg-indigo-400",
  shift_confirm_reminder: "bg-amber-500",
  shift_confirm_urgent: "bg-orange-600",
  no_clock: "bg-destructive",
  no_clockin_alert: "bg-destructive",
  no_show_alert: "bg-destructive",
