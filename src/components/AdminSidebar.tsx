...
const ALL_LINKS: LinkDef[] = [
  ...
  { to: "/app/shift-requests", icon: MessageSquare, label: "Solicitudes turno", module: "shifts", section: "Programación" },
  { to: "/app/requests", icon: ListChecks, label: "Solicitudes", module: null, section: "Gestión" },
