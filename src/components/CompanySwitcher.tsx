...
import { Check, ChevronsUpDown, Search, LayoutDashboard, User } from "lucide-react";
import {
    ...
    return (
      <div className={cn(
        ...
        <div className="relative">
          ...
          {/* Tiny mode dot for collapsed single-company */}
          {isDual && collapsed && (
            <span className={cn(
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        ...
        className="w-[280px] p-0 rounded-xl shadow-xl border-border/50"
      >
        {/* Header with mode context */}
        ...
        <div className="px-2 pb-2 max-h-[280px] overflow-y-auto scrollbar-thin space-y-0.5">
