...
export const ADMIN_NAV_ITEMS: NavItem[] = [
  ...
  { id: "service-requests", to: "/app/service-requests", icon: ClipboardList, label: "Requests · Intake", module: null, section: "Intake", badge: "NEW" },
  { id: "staffing-requests", to: "/app/staffing-requests", icon: ClipboardList, label: "Staffing Requests", module: null, section: "Intake" },
  { id: "invoices", to: "/app/invoices", icon: Receipt, label: "Invoices", module: null, section: "Commercial" },
  { id: "service-categories", to: "/app/service-categories", icon: Tags, label: "Service Categories", module: null, section: "Administration" },
  ...
  { id: "payroll-review-queue", to: "/app/payroll-review-queue", icon: ScanEye, label: "Centro de Validación", module: null, section: "Payroll", roles: ["developer", "owner", "company_owner", "admin"] },
