...
export const ADMIN_NAV_ITEMS: NavItem[] = [
  ...
  { id: "validation-center", to: "/app/validation-center", icon: ScanEye, label: "Centro de Validación", module: null, section: "Payroll", roles: ["developer", "owner", "company_owner", "admin"], mobile: "primary", mobileSection: "Operación" },
  { id: "payroll-review-queue", to: "/app/payroll-review-queue", icon: ScanEye, label: "Cola de revisión payroll", module: null, section: "Payroll", roles: ["developer", "owner", "company_owner", "admin"], mobile: "hidden" },
