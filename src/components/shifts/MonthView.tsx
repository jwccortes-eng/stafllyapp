...
export function MonthView({ currentMonth, shifts, assignments, locations, clients, onShiftClick, onDropOnShift }: MonthViewProps) {
            ...
            return (
              <div key={day.toISOString()} className={cn(
                ...
                <div className="space-y-1">
                  ...
                  {dayShifts.length > 3 && (
                    <p className="text-[9px] text-muted-foreground text-center">+{dayShifts.length - 3} más</p>
                  )}
                </div>
              </div>
            );
